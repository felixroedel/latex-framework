...
\usepackage[ngerman,shorthands=off]{babel}       % German LaTeX-intern descriptors (Abbildungen, ...)
\usepackage[ngerman]{translator}       
% \usepackage{mathastext}                       % default font in mathematical Environments
...
\usepackage{minted}                           % Better Code support for LaTeX, py based highlighting
\usepackage[ruled,vlined]{algorithm2e}        % Support for writing algorithms in LaTeX
...
\usepackage{nicefrac}                         % Support for inline fractions
