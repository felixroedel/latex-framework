...
\pagestyle{fancy}
\newcommand{\defaultHeaderRight}{\lhead{\nouppercase{\leftmark}}}
...
\addto{\captionsngerman}{
  ...
  \renewcommand*{\algorithmcfname}{Algorithmus}                % Algorithm should be displayed as "Algorithmus x"
  %
...
\pretocmd{\gls}{\stepcounter{countacronym}}{}{} % needed for \gls usage of acronyms
...
\newcommand*{\nomen}[3]{\nomenclature[#1]{#2}{#3}\stepcounter{countnomen}}
...
\renewcommand\nomgroup[1]{%
  \ifstrequal{#1}{A}{
    \nopagebreak
    \item[\textbf{Symbol}] \textbf{Bedeutung} \hfill \textbf{Einheit}}{%
      \ifstrequal{#1}{B}{
        \nopagebreak
        \item[\textbf{Indizes}] \textbf{Bedeutung}}{%
          \ifstrequal{#1}{C}{\nopagebreak
          \item[\textbf{Notation}] \textbf{Bedeutung}}{}
      }%
  }%
}
...
\newcommand{\algoref}[1]{\hyperref[#1]{Alg.~\getrefnumber{#1}}}
...
\newcommand{\printAbstractGerman}{
  \IfFileExists{./sections/abstract_german.tex}{
    \newpage
    \fancypagestyle{abstractGerman}{
      \fancyhead[L]{Zusammenfassung}
    }
    \thispagestyle{abstractGerman}
...
\newcommand{\printBlockingNote}{
  \IfFileExists{./sections/blocking_note.tex}{
    \newpage
    \fancypagestyle{blockingNote}{
      \fancyhead[L]{Sperrvermerk}
    }
    \thispagestyle{blockingNote}
...
\addbibresource{registers/bibliography.bib}
...
% -------------------------------------------------------------------
% use mathcha.io for better tikz usage
\usetikzlibrary{shapes, arrows, positioning, bending, calc, chains, intersections}
